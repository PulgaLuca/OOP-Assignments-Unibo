...
public class WorkWithShapes {
    ...
    public static void main(final String[] args) {
        ...
        final Polygon scaleneTriangle = new SimpleTriangle(TRIANGLE_EDGE_1, TRIANGLE_EDGE_2, TRIANGLE_EDGE_3, TRIANGLE_H);
        ...
        System.out.println("Scalene triangle with parameters (" + TRIANGLE_EDGE_1 + ", " + TRIANGLE_EDGE_2 + ", " + TRIANGLE_EDGE_3 + ", " + TRIANGLE_H + "): " + shapeDetails(scaleneTriangle));
        System.out.println("Scalene triangle with parameters (" + TRIANGLE_EDGE_1 + ", " + TRIANGLE_EDGE_2 + ", " + TRIANGLE_EDGE_3 + "): " + shapeDetails(scaleneTriangle2));
    }
}
